# Android Project 4 - *TrendyTV*

Submitted by: **Agrika Gupta**

**TrendyTV** is a TV show browsing app that allows users to browse currently popular TV shows. Upon clicking a particular TV show, users can see the full overview, average number of stars out of 10, and total number of voters for the movie.
